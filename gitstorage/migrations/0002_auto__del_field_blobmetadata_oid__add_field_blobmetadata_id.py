...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BlobMetadata.oid'
        db.rename_column(u'gitstorage_blobmetadata', 'oid', 'id')

    def backwards(self, orm):
        # Deleting field 'BlobMetadata.id'
        db.rename_column(u'gitstorage_blobmetadata', 'id', 'oid')
    ...
    models = {
        ...
        u'gitstorage.blobmetadata': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '40', 'primary_key': 'True', 'db_index': 'True'}),
            'mimetype': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        u'gitstorage.treemetadata': {
            'Meta': {'object_name': 'TreeMetadata', 'managed': 'False'},
            'id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '40', 'primary_key': 'True', 'db_index': 'True'}),
            'mimetype': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
